...
![Workflow: (1) an image is sent to AWS Bedrock, (2) the Titan Multimodal model turns it into an embedding — a list of 1,024 numbers, (3) the image and its vector are stored together in one IBM Db2 row](docs/workflow_linkedin.png)
