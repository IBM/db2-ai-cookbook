...
| Recipe | Framework | Source document | Chunking | Models | Form  | Last checked |
|---|---|---|---|---|---|---|
| [haystack-local-models](haystack-local-models/) | [Haystack](https://haystack.deepset.ai/) pipelines | a **PDF**, parsed by [Docling](https://github.com/docling-project/docling) | `HybridChunker`, on section boundaries | via [llama.cpp](https://github.com/ggml-org/llama.cpp), OpenAI-compatible API · 384-d | Python scripts  | ✅ 2026-07-29 |
